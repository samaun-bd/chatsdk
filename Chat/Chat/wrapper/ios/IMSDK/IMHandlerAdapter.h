...
public:
    ...
    void onFriendChatSeen(UserIdentity userId, UserIdentity friendid, const std::vector<imsdk::SeenPacketDTO> &seenPacketList, bool fromAnonymousUser);
    void onFriendChatSeenConfirmed(UserIdentity userId, UserIdentity friendid, std::vector<imsdk::SeenPacketDTO> &packetIds, bool fromAnonymousUser);
    ...
    void onGroupChatReceived(UserIdentity friendid, GroupIdentity groupid, const std::string &packetId, int messageType, const std::string &message, long long messageDate, bool fromOnline);
    void onGroupChatDelivered(UserIdentity friendid, GroupIdentity groupid, const std::string &packetId);
    void onGroupChatDeleted(UserIdentity friendid, GroupIdentity groupid, const std::vector<std::string> &packetIdList);
    ...
    void onGroupChatSeen(GroupIdentity groupid, const std::vector<std::string> &packetIds);
...
//    void onGroupMemberListSent(GroupIdentity groupId, const std::string &packetId);
...
//    void onGroupMemberListReceived(GroupIdentity groupid, const std::vector<imsdk::MemberDTO> &memberList);
    ...
    void onGroupMemberAdded(UserIdentity friendid, GroupIdentity groupid, const std::vector<imsdk::MemberDTO> &memberList, const std::string &packetId);
//    void onGroupInformationSent(GroupIdentity groupId, const std::string &packetId, bool isUpdate);
//    void onGroupInformationReceived(UserIdentity friendid, GroupIdentity groupid, const std::string &groupName, const std::string &groupUrl, int numberOfMembers, bool isUpdate);
    ...
    void onGroupMemberStatusChanged(UserIdentity senderid, GroupIdentity groupid, const std::vector<imsdk::MemberDTO> &memberList, const std::string &packetId);
    ...
    void onGroupInformationWithMembersReceived(GroupIdentity groupId, const std::string &groupName, const std::string &groupUrl, const std::vector<imsdk::MemberDTO> &memberList);
    ...
    void onGroupChatConversationListReceived(const std::vector<imsdk::SDKMessageDTO> &conversationList, bool isFromSynced);
    ...
    void onFriendFileManifestUploaded(UserIdentity userId, UserIdentity friendId, const std::string &packetId, std::string cloudManifestUrl, int messageType, int timeout, std::string caption, int widthOrFileSize, int heightOrDuration);
    void onFriendIncomingChatMedia(UserIdentity userId, UserIdentity friendId, std::string fileName, const std::string &packetId, int messageType, int timeout, long long messageDate, bool isSecretVisible, std::string caption, int widthOrFileSize, int heightOrDuration);
    ...
    void onFriendChatMediaDownloadCompleted(UserIdentity userId, UserIdentity friendId, std::string fileNameWithPath, const std::string &packetId, int messageType, int timeout);
    ...
    void onGroupIncomingChatMedia(UserIdentity friendId, GroupIdentity groupId, std::string fileName, const std::string &packetId, int messageType, long long messageDate, std::string caption, int widthOrFileSize, int heightOrDuration);
    ...
    void onGroupChatMediaDownloadCompleted(UserIdentity friendId, GroupIdentity groupId, std::string fileNameWithPath, const std::string &packetId, int messageType);
    ...
    void onSyncGroupHistoryMessageReceived(GroupIdentity groupId, const std::string &packetId, const std::vector<imsdk::SDKMessageDTO> &groupHistoryMessageList, const std::vector<imsdk::GroupActivityDTO> &groupActivityList, long long oldestMessageDate, int direction);
